          ...
          .each((i, v) => {
            ...
            if (name !== undefined) {
              ...
              if (!already_checked.includes(name)) {
                ...
                to_push.searches = $(v)
                  .find("div .col-auto.col-lg.order-lg-3")
                  .text();
...
exports.skinHash = (hash) =>
  new Promise((resolve) => {
    resolve(
      `https://texture.namemc.com/${hash[0]}${hash[1]}/${hash[2]}${hash[3]}/${hash}.png`
    );
  });
